...
<body>
    ...
    <div class="container">
        <?php $__currentLoopData = $Salidas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <table class="table table-hover table-dark">
                <thead>
                    <tr>
                        <th colspan="5" style="text-align: center">Salida: <?php echo e($i->id); ?> dia:<?php echo e($i->created_at); ?> </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th colspan="5" style="text-align: center">Cliente: <?php echo e($i->Cliente); ?></th>
                    </tr>
                    <tr>
...
</html><?php /**PATH D:\Escritorio\naviera1\resources\views/PDF/NotaDeSalida.blade.php ENDPATH**/ ?>